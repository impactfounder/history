...
드러난 것:
- **수집기 연도 오류.** `ko:한국사 연표` 표의 시대 행은 첫 셀이 시대명("부여")이고 연도가 본문에 흩어져 있어 행 연도가 틀린다(#8이 250으로 읽힘 — 실제는 BC 4세기·BC 238). 첫 셀이 연도로 안 읽히면 본문의 첫 연도를 쓰도록 `collect.mjs`를 고쳐야 한다.
