...
- **작품류는 3 이하**(2026-09-05, 대표 지적 "겨울연가가 세기 대표?"): 위키데이터 P31이 TV 시리즈·영화·앨범·노래·게임·책·문학 작품이면 언어판 수가 많아도 세기·십년 레벨에 올리지 않는다.
- **같은 중요도 안의 순서는 언어판 수**(발행 §6-2 정렬 키 `sl`). 연도순이면 셀이 좁을 때 그 세기의 첫 해 사건이 대표가 된다.
